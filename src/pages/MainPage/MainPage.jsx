        ...
        <div>
            ...
            <Main>
                <div className="text-box">
                    <h1>Welcome to <span>mkyy Space</span></h1>
                    <p>Neste espaço você pode encontrar ferramentas essenciais que um Dev precisa, acessando a área "Tools", e também pode ver um pouco mais sobre o desenvolvedor por trás disso.</p>
                </div>
